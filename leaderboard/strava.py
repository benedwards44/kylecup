...
class StravaClient():
    ...
    def sync_activities(self, month_slug):
        ...
        for athlete in Athlete.objects.filter(strava_access_token__isnull=False, strava_connection_status='Connected'):
    ...
    def process_webhook_event(self, object_id, owner_id):
        ...
        try:
            ...
            raise Exception('Could not find connected athlete for owner_id %s' % owner_id)
